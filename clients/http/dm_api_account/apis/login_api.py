...
class LoginApi(RestClient):
    ...
    @allure.step("Аутентификация с помощью учетных данных")
    ...
    @allure.step("Выйти из системы как текущий пользователь")
    ...
    @allure.step("Выйти из системы со всех устройств")
